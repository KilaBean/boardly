...
/**
 * Google's mark, inlined as SVG.
 *
 * Not an <img> from a CDN: a remote asset here would be a third-party request
 * on the sign-in page and would break under a strict connect/img CSP.
 */
function GoogleMark() {
  return (
